...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/debugcode/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/debugcode',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/debugcode/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/debugcode/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/debugcode/' + theme + '/jcr:content?wcmmode=disabled';
