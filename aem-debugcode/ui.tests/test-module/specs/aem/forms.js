...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/aem-debugcode/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/aem-debugcode',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/aem-debugcode/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/aem-debugcode/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/aem-debugcode/' + theme + '/jcr:content?wcmmode=disabled';
